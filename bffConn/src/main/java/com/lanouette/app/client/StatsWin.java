...
public class StatsWin extends Window {
    ...
    public StatsWin(final ArrayList<UserContainer> users) {
        ...
        ListGridField messagesField = new ListGridField("messages", Canvas.imgHTML("msg.png"), gridColumnWidth);
        ListGridField editedField = new ListGridField("edited", Canvas.imgHTML("edited.png"), gridColumnWidth);
        ListGridField deletedField = new ListGridField("deleted", Canvas.imgHTML("eraser_s.png"), gridColumnWidth);
        ListGridField starsSentField = new ListGridField("starssent", Canvas.imgHTML("star_up_20.png"), gridColumnWidth);
        ListGridField starsRcvdField = new ListGridField("starsrcvd", Canvas.imgHTML("star_down_20.png"), gridColumnWidth);
        ...
        myMessagesButton.setWidth(headerButtonSize);
        myMessagesButton.setHeight(headerButtonSize);
        ...
        myDeletedButton.setWidth(headerButtonSize);
        myDeletedButton.setHeight(headerButtonSize);
        ...
        myDeletedButton.setSrc("eraser.png");
        ...
        myEditedButton.setWidth(headerButtonSize);
        myEditedButton.setHeight(headerButtonSize);
        ...
        myStarsSentButton.setWidth(headerButtonSize);
        myStarsSentButton.setHeight(headerButtonSize);
        ...
        myStarsRcvdButton.setWidth(headerButtonSize);
        myStarsRcvdButton.setHeight(headerButtonSize);
        ...
        if (RuntimeData.getInstance().isMobile()) {
            bottomStack.setAlign(Alignment.RIGHT);
            bottomStack.setHeight(32);
            bottomStack.setWidth100();
            bottomStack.setRight(0);
            bottomStack.setStyleName("bottomStack");
            bottomStack.addMember(myCloseButton);
            bottomStack.addMember(myCloseLabel);
            bottomStack.addClickHandler(new ClickHandler() {
                public void onClick(ClickEvent event) {
                    event.cancel();
                    destroy();
                }
            });
            vStack.addMember(bottomStack);
        }
